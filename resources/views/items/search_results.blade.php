...
@section('title')
    Kenya Classifieds : Search Results
@endsection

@section('description')
    <meta name="description" content="Kenya Classifieds. Mudhrua, Gikomba Online. Online Soko, Post item for Sale Here. Search Results">
@endsection
